        ...
        <div class=’single_l‘   col-md-10>
         ...
         <h1>".$row['resname']."</h1>
           ...
           <div class='single-ms col-md-8' >
             <p><span>大小</span>：".$row['space']." <span><br>软件分类</span>：".$row['resfenlei']."<br>
<span>语言</span>：".$row['language']." <br><span>更新日期</span>：".$row['uptime']."<br>
<span>支持系统</span>：".$row['support']."</p>
            <a href='".$row['http']."'><button type='bu.contentton' class='btn btn-primary'>高速下载</button></a>
           </div>
